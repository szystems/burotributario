        ...
        <div class="col-xl-12 col-sm-12 mb-xl-0 mb-4">
            <div class="card">
                ...
                <div class="card-body p-3 pt-2">
                    <h4><u>{{ __('Editar') }} {{ __('Audio') }}</u></h4>
                    <p><strong><u>{{ __('Course') }}:</u></strong> {{ $course->name }}</p>
                    <p><strong><u>{{ __('Audio') }}:</u></strong> {{ $audio->name }}</p>
                    @if (count($errors)>0)
                    ...
                    <form action="{{ url('update-audio/'.$audio->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            {{-- <div class="col-md-12 mb-3">
                                ...
                                <input readonly type="text" class="form-control border px-2 " name="name" value="{{ $audio->name }}">
                                @if ($errors->has('name'))
                            ...
                            {{-- <div class="col-md-12 mb-3">
                                ...
                                <textarea readonly name="description" cols="30" rows="5" class="form-control border px-2 ">{{ $audio->description }}</textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="">{{ __('Cambiar Audio') }}</label>
                            ...
                            <div class="col-md-12 mb-3" >
                                ...
                                <textarea hidden name="description" cols="30" rows="5" class="form-control border px-2 ">{{ $audio->description }}</textarea>
                                <input hidden type="text" class="form-control border px-2 " name="name" value="{{ $audio->name }}">
